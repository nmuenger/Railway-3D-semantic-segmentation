...
data_root = "/kaggle/input/osdar23/preprocessed_pcd"
...
data = dict(
    ...
    train=dict(
        ...
        data_root=data_root,
        transform=[
            dict(type="PolarMix", p_swap=0.0, p_instance_copy=1),
            ...
            dict(
                type="Collect",
                keys=("coord", "grid_coord", "segment", "scene", "frame", "instance"),
