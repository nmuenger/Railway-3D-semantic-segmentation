...
# ---- misc custom setting ----------------
sweep=False # Set by default to false. If you wnat to run sweep, use the --options sweep==True option
...
augmented_sampler = dict(active = False,
                         augmentations_list = [
...
# ---- Split to Seq. -------------------------------------
split2seq = dict(
            train = ["3_fire_site_3.3"],
            # train=["3_fire_site_3.3","9_station_ruebenkamp_9.1","20_vegetation_squirrel_20.1"],
...
data = dict(
    ...
    train=dict(
        ...
        transform=[
            ...
            #dict(type="Sparsify", end_range=80, track_label=learning_map["track"], p=0.5), # start_range = lower bound of 10 meter section 
