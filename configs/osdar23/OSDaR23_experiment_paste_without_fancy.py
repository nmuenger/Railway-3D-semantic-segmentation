...
data = dict(
    ...
    train=dict(
        ...
        transform=[
            ...
            dict(type="PolarMixPaste", p=0.0, csv_stat_path="/workspaces/baseline/railseg/csv_stats/pedestrian_density_per_distance.csv", apply_rotation=False, put_to_back_prob=1,),
