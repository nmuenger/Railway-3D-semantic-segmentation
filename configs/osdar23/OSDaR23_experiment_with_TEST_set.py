"""WARNING!!!!!!!
THIS CONFIG IS NOT REALISTIC, AND SHOULD NOT BE TAKEN AS IS. THE VALIDATION SET WAS EXCHANGED FOR THE TEST SET;
THAT IS DONE SO THAT WE CAN RUN THE EVALUATION PROCEDURE BUT WITH THE TEST SET!!!!!!!!!!!!
...
upload_pcd_every_x_epoch = 20 # The pcd will be uploaded every x epoch
...
data = dict(
    ...
    train=dict(
        ...
        transform=[
            ...
            dict(type="PolarMixPaste", p=0.0, csv_stat_path="/workspaces/baseline/railseg/csv_stats/pedestrian_density_per_distance.csv"),
            ...
            dict(type="Sparsify", end_range=50, track_label=learning_map["track"], p=0), # start_range = lower bound of 10 meter section 
